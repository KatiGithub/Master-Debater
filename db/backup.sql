...
-- Started on 2021-08-25 00:16:16
...
--
-- TOC entry 3058 (class 1262 OID 16407)
-- Name: MasterDebater; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "MasterDebater" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'English_United States.1252';


ALTER DATABASE "MasterDebater" OWNER TO postgres;

\connect "MasterDebater"
...
-- Completed on 2021-08-25 00:16:16
